...
public class BerkeleyUtil {
    ...
    // 数据库名  
    private static String dbName = "gcmobilecms_database";  
  
    public BerkeleyUtil(String homeDirectory) {  
        ...
        try {
			env = new Environment(FileUtil.createFileDirectory(homeDirectory), envConfig);
