...
<div class="page-group page">
    <header class="bar bar-nav red1">
		<a class="button button-link button-nav header-left-link pull-left external" href="transfer.html" data-transition='slide-out'>
            <img class="header-img" src="../img/login/back_arrow.png">
        </a>
        
        <h1 class="title"><span class="font-white font-18">${eduzhuanhuanjilu}</span></h1>
...
<script type='text/javascript' src='../js/conversion_records.js' charset='utf-8'></script>
</body>
</html>