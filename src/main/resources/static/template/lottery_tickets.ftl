...
<head>
    ...
    <link rel="stylesheet" href="../../css/betting/lottery_tickets.css">
</head>
<body>
<div class="page-group page">
    <header class="bar bar-nav red1">
		<a class="button button-link button-nav header-left-link pull-left external" href="../betting.html" data-transition='slide-out'>
            <img class="header-img" src="../../img/login/back_arrow.png">
        </a>
        
        <h1 class="title"><span class="font-white font-18">${caipiaoyouxi}</span></h1>
   				...
   				<div class="row">
   					...
   					<div class="col-75">
	   					<select id="record-type">
		                    <option value="" selected="selected">${suoyoucaipiaozhonglei}</option>
		                    <#list lts as lotteryType>
		                    	<option value="${lotteryType.value}">${lotteryType.name}</option>
							</#list>
		                </select>
   				...
   				<div class="row">
   					...
   					<div class="col-75">
	   					<select id="record-state">
			                <option value="" selected="selected">${suoyouzhuangtai}</option>
			                <option value="N">${zhengchang}</option>
			                <option value="P">${yijiesuan}</option>
			                <option value="C">${yiquxiao}</option>
			            </select>
		   				<span class="icon icon-right"></span>
	   				</div>
   				</div>
...
<script type='text/javascript' src='../../js/betting/lottery_tickets.js' charset='utf-8'></script>
</body>
</html>