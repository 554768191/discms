...
<div class="page-group page">
    <header class="bar bar-nav red1">
        ...
        <h1 class="title"><span class="font-white font-18">${yhk}</span></h1>

		<a class="button button-link button-nav header-left-link pull-right external isnull" href="banks_edit.html" data-transition='slide-out'>
            <span class="font-white">${bianji}</span>
        </a>
        <a class="button button-link button-nav header-left-link pull-right external isnull" href="banks_edit.html" data-transition='slide-out'>
            <span class="icon icon-card font-white"></span>
        </a>

    </header>
    
    <div class="content gray">
   		<div class="bank_list font-14">
...
<script type='text/javascript' src='../js/bank.js' charset='utf-8'></script>
</body>
</html>