...
<head>
    ...
    <link rel="stylesheet" href="../../css/betting/lottery_tickets_details.css">
</head>
<body>
<div class="page-group page">
    <header class="bar bar-nav red1">
		<a class="button button-link button-nav header-left-link pull-left external" href="lottery_tickets.html" data-transition='slide-out'>
            <img class="header-img" src="../../img/login/back_arrow.png">
        </a>
        
        <h1 class="title"><span class="font-white font-18">${caipiaomingxi}</span></h1>
    ...
    <div class="content gray infinite-scroll infinite-scroll-bottom native-scroll" data-distance="50">
   		<div class="details-list font-14">
   			
   		</div>
   		
   		<div class="details-info font-14">
...
<script type='text/javascript' src='../../js/betting/lottery_tickets_details.js' charset='utf-8'></script>
</body>
</html>