...
<head>
    ...
    <link rel="stylesheet" href="../css/deposit_prompt.css">
</head>
<body>
<div class="page-group page">
    <header class="bar bar-nav red1">
       
        <h1 class="title"><span class="font-white font-18">${tijiaochenggong}</span></h1>
        
    </header>

    <div class="content gray">
		<div class="prompt-info font-20">
			<label>
				<span id="time">5</span> 
				${miaohoutiaozhuandao} 
				<a class="external" href="index.html">${shouye}</a>
			</label>
		</div>
    </div>
</div>
...
<script type='text/javascript' src='../js/deposit_prompt.js' charset='utf-8'></script>
</body>
</html>