...
<div class="page-group page">
    <header class="bar bar-nav red1">
        ...
        <h1 class="title"><span class="font-white font-18">${xuanzecunkuanleixing}</span></h1>
        
    </header>

    <div class="content gray">
        <div class="menu-list font-14" style="margin-top: 1rem;">
           <#list paytypeConfigration as ptc>
            <div class="row">
            	<a href="${ptc.link}" class="external">
	                <div class="col-85">${ptc.name}</div>
...
<script type='text/javascript'>
  var despoistBindBank="${despoistBindBank?string('true','false')}";
  if(despoistBindBank=="true"){
    httpRequest.get(
