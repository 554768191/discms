...
//farmat 时间
function farmart(longDate){
	if(longDate){
		var now = new Date(parseInt(longDate));
					...
					if(data.list && data.list.length > 0){
						for(var i = 0; i < data.list.length; i++){
							...
							"<div class='row'>" + 
								...
								"<div class='col-66'>" + farmart(data.list[i].gamedate) + "</div>" +
							"</div>" +
							"<div class='row'>" +
							...
							"<div class='row'>" +
								...
								"<div class='col-66'>" + formatMoney(formatMoneyIsNull(data.list[i].bet)/100) + "</div>" +
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_shuying"] + "(¥)</div>" +
								"<div class='col-66'>" + formatMoney(formatMoneyIsNull(data.list[i].win)/100) + "</div>" +
							"</div>" +
						"</div>";
						}
