					...
					if(data.list && data.list.length > 0){
						for(var i = 0; i < data.list.length; i++){
							...
							"<div class='row'>" +
								...
								"<div class='col-66'>" + data.list[i].productName + "</div>" +
							"</div>" +
							"<div class='row'>" +
							...
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_zhuotaimingcheng"] + "</div>" +
								"<div class='col-66'>"+ data.list[i].tableid + "</div>" +
							"</div>" +
