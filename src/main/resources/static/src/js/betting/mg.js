					...
					if(data.list && data.list.length > 0){
						for(var i = 0; i < data.list.length; i++){
							...
							"<div class='row'>" +
								...
								"<div class='col-66'>" + data.list[i].displayname + "</div>" +
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_tingming"] + "</div>" +
								"<div class='col-66'>"+ data.list[i].displaynamecategory + "</div>" +
							"</div>" +
							"<div class='row'>" +
							...
							"<div class='row'>" +
								...
								"<div class='col-66'>" + formatMoney(formatMoneyIsNull(data.list[i].pay-data.list[i].bet)/100) + "</div>" +
							"</div>" +
						"</div>";
						}
