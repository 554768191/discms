				...
				function(data){
					...
					if(data.list && data.list.length > 0){
						for(var i = 0; i < data.list.length; i++){
							...
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_bisairiqi"] + "</div>" +
								"<div class='col-66'>" + data.list[i].matchdatetimestr + "</div>" +
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_wanfa"] + "</div>" +
								"<div class='col-66'>" + data.list[i].bettypechn + "</div>" +
							"</div>" +
							"<div class='row' style='height:100%;'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_touzhuneirong"] + "</div>" +
								"<div class='col-66' style='line-height: 1.2rem;'>"+ data.list[i].html + "</div>" +
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_touzhujine"] + "(¥)</div>" +
								"<div class='col-66'>" + formatMoney(formatMoneyIsNull(data.list[i].betamt)/100) + "</div>" +
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_jiesuanjine"] + "(¥)</div>" +
								"<div class='col-66'>" + formatMoney(formatMoneyIsNull(data.list[i].payamt)/100) + "</div>" +
							"</div>" +
							"<div class='row'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_zhuangtai"] + "</div>" +
								"<div class='col-66'>" + formatStatus(data.list[i].settled) + "</div>" +
								"</div>" +
							"<div class='row' style='height:100%;'>" +
								"<div class='col-33 font-right font-bold'>" + languagePackage["js_saiguo"] + "</div>" +
								"<div class='col-66' style='line-height: 1.2rem;'>" + data.list[i].matchresulthtml + "</label></div>" +
							"</div>" +
						"</div>";
						}
