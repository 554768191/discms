    ...
    <div class="content gray close-panel">
        ...
        <#list gameTypes as gameType>
            ...
            <#if gameMap[gameType.id?c]?size==0>
                <div class="background-black row no-gutter">
                  <div class="col-50 text-center" style="padding: 0;">
                          <div style="padding:0.25rem 0.25rem 0 0.25rem;"><img src="../img/icon/more.png" style="max-width: 100%"></div>
                          <div class="background-gray3"><span class="font-bold font-gray font-middle">${qidaigengduo}</span></div>
                  </div>
                </div>  
            </#if>
            <#list gameMap[gameType.id?c] as game>
                ...
                <div class="col-50 text-center" style="padding: 0;" onclick="toProduct('${game.href}')">
                    <div style="padding:0.25rem 0.25rem 0 0.25rem;"><img src="../img/icon/${game.icon}.png" style="max-width: 100%"></div>
                    <div class="background-gray3"><span class="font-bold font-gray font-middle">${game.name}</span></div>
                </div>
                <#if (game_index+1)==gameMap[gameType.id?c]?size>
                   <#if game_index%2==0>
                      <div class="col-50 text-center" style="padding: 0;">
                          <div style="padding:0.25rem 0.25rem 0 0.25rem;"><img src="../img/icon/more.png" style="max-width: 100%"></div>
                          <div class="background-gray3"><span class="font-bold font-gray font-middle">${qidaigengduo}</span></div>
        ...
        <div class="content-block text-center" id="lang">
            <#list langs as lan>
               <#switch lan>
                  ...
                  <#case "KH">
                     <div class="row no-gutter" style="margin: 1rem 0">
                        <div class="col-40"><img data-lang="KH" src="../img/icon/flag_kh.png" style="width: 2rem; vertical-align: middle;"></div>
                        <div class="col-60" style="line-height: 2rem;"><span style="color: #9A9A9A;">${taiyu}</span></div>
                     </div> 
                  <#break>
                  <#case "TH">
                     <div class="row no-gutter" style="margin: 1rem 0">
                        <div class="col-40"><img data-lang="TH" src="../img/icon/flag_th.png" style="width: 2rem; vertical-align: middle;"></div>
